...
public class MasterRepository<TEntity> : IUnitRepository<TEntity> where TEntity : class
{
    ...
    public virtual TEntity? GetBySpec<Spec>(Expression<Func<TEntity, bool>> predicate)
    {
        return _context.Set<TEntity>().FirstOrDefault(predicate);
    }

    public virtual ICollection<TEntity> List(Expression<Func<TEntity, bool>> predicate)
    {
